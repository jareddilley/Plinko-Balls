'''
v4 plinko game with pin and bin animations, y-dampened collision bouncing, color mathced drop location plotting
Inputs -
    ...
    for ball in balls:
        ...
        for pin_x, pin_y in pins:
            ...
            if dist_sq < radius_sum ** 2:
                ...
                random_factor = 0.35 + random.uniform(-0.1, 0.1)  # Random damping factor

                # Apply randomness and dampening
                ball[2], ball[3] = reflected_velocity * random_factor
                ball[3] *= 1.25 # more bouce in the y
