'''
v6 plinko game with sounds, pin and bin animations, x dampening and baising collision bouncing, color mathced drop location plotting
Inputs -
...
def reset_board():
    global pin_rows, balls_at_once, ball_radius, balls, hit_bins, del_balls_x, plot_image, recent_bins, bias
    pin_rows = 16
    create_pins()
    balls_at_once = 1
    ball_radius = int(9 * ratio)
